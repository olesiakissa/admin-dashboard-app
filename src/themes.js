...
const srcFontFamily = ["Source Sans Pro", "sans-serif"].join(",");
    ...
    return {
        palette : {
            ...
            ...(mode === 'dark' ? {
                ...
                background : {
                    default : "#FCFCFC" // default light gray
                }
            })
        }, // end palette
        typography : {
            fontFamily : srcFontFamily,
            fontSize : 12,
            h1 : {
                fontFamily : srcFontFamily,
                fontSize : 40
...
export const useMode = () => {
    ...
    const colorMode = useMemo( // memoization of value based on previous value
        () => ({
            toggleColorMode : () => 
